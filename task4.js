function Appliances(type, model, power) {
    this.type = type,
    this.model = model,
    this.power = power,
    this.isOnOff = false
...
Appliances.prototype.totalPower = function() {
...
console.log(`Потребляемая мощность работающих приборов = ${tv.totalPower() + fridge.totalPower() + fridge.totalPower() + kettle.totalPower()} Вт`);